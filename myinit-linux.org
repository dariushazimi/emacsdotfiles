...
* Org mode
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq org-agenda-files (list "~/Dropbox/orgfiles/gcal.org"
                                 "~/Dropbox/orgfiles/dailyplan.org"
    ...
    (setq org-capture-templates
          '(("a" "Appointment" entry (file  "~/Dropbox/orgfiles/gcal.org" )
            ...
            ("t" "To Do Item" entry (file+headline "~/Dropbox/orgfiles/i.org" "To Do and Notes")
             "* TODO %?\n%u" :prepend t)
            ("m" "Events" entry (file+headline "~/Dropbox/orgfiles/i.org" "To Do and Notes")
             "* TODO %a\n %?" :prepend t)
            ...
            ("n" "Note" entry (file+headline "~/Dropbox/orgfiles/i.org" "Notes")
             "* %u %? " :prepend t)
            ("d" "Things today" checkitem (file+datetree "~/Dropbox/orgfiles/dailyplan.org")
            "[ ] %?"   
            "[ ] %?"
            "[ ] %?")
            ))
            
(defun schedule-dailyplan-hook ()
  (if (string= (org-capture-get :description)
               "Things today")     ;Must match the description in the template
      (org-schedule 0 (format-time-string "%Y-%m-%d"))))

(add-hook 'org-capture-before-finalize-hook 'schedule-dailyplan-hook)
...
* Avy - navigate by searching for a letter on the screen and jumping to it
  ...
  (use-package avy
  :ensure t
  :bind ("M-w" . avy-goto-word-1) ;; changed from char as per jcs
...
(define-key z-map (kbd "*") 'calc)
  ...
  (setq user-full-name "Dariush Azimi"
                          user-mail-address "azimid@gmail.com")
  ;;--------------------------------------------------------------------------
